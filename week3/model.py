...
class ColaModel(pl.LightningModule):
    ...
    def validation_step(self, batch, batch_idx):
        ...
        self.outputs_val_end = outputs
        self.labels_val_end = labels
    ...
    def on_validation_epoch_end(self):
        ...
        labels = self.labels_val_end #torch.cat([x["labels"] for x in outputs])
        logits = self.outputs_val_end.logits #torch.cat([x["logits"] for x in outputs])
